...
const PasswordInput = (props: PasswordInputProps) => {
  const {id, label, name, value, handler} = props;
  const [isVisible, setVisability] = useState(false);
  return (
    <div className="form-field form-field_password">
      ...
      />
      <button className="form-field__eye-btn" onClick={(e: React.SyntheticEvent) => {
        e.preventDefault();
